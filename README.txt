...
-execute ftclient.py on Host B, specifying the server host and port #, the name of the file 
 you wish to receive (if using the '-g' command), and a valid port # on which to receive the data.
